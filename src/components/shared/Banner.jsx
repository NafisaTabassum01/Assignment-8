...
<div className='container mx-auto flex flex-col md:flex-row justify-around gap-20 pt-10'>
                 <div className='p-5 pt-8'><p className='text-[54px] text-[#884E1B] font-extrabold'>Find Your Perfect <br /> Qurbani Animal</p>
             <p className='text-[17px] text-[#455a2ecf] font-semibold pt-5'>Healthy Animal,Trusted Farm,Easy Booking.</p> <p></p> <br />

             <Link href={"/allAnimal"}> <button className='btn bg-[#2A381A] text-white font-medium'>Browse All Animals<Image src={arrow} alt=''/></button></Link>
